...
export default function BookingSuccess() {
  ...
  return (
    <div className="w-full flex items-center justify-center px-0 relative">
      {/* Confetti lines */}
     ...
     Підтвердження надіслано на {phone}
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-1 sm:justify-end">
              <button
                type="button"
                onClick={() => navigate("/")}
                className="rounded-2xl bg-gray-900 text-white py-3 px-5 font-semibold hover:bg-black active:scale-[0.99] transition"
              >
                На головну
              </button>
