...
export default function TimeSelect({
  ...
  function handleClose() {
    setDraftValue(initialValue || "08:00");
    setOpen(false);
  }

  const timePickerModal = open ? (
    <div className="fixed inset-0 z-[10150] flex items-center justify-center bg-[#202020]/45 p-3 backdrop-blur-[6px] sm:p-6">
      <button
        type="button"
      ...
      <div
        ...
        className="relative z-10 flex max-h-[calc(100dvh-24px)] w-full max-w-lg flex-col overflow-hidden rounded-[30px] border border-[#f0e2d3] bg-[#f7f5f1] shadow-[0_30px_90px_rgba(15,23,42,0.24)]"
      >
...
className={cn(
  `
    inline-flex h-11 min-w-[155px] items-center justify-center
    rounded-2xl px-6
    text-sm font-black
