      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        ...
        <div className="mt-8 rounded-3xl border border-gray-200 bg-white p-6 sm:p-8">
          <p className="text-sm leading-6 text-gray-700">
            ...
            сервісу <span className="font-semibold">PlaniDay</span> клієнтами.
          ...
          <Section title="1. Опис сервісу">
            <p>
              PlaniDay — це платформа для пошуку студій або майстрів та
          ...
          <Section title="3. Онлайн-запис">
            <p>
              Клієнт може використовувати PlaniDay для бронювання послуг у
          ...
          <Section title="4. Скасування та зміна записів">
            ...
            <p>
              PlaniDay надає лише технічну можливість взаємодії, але не
          ...
          <Section title="5. Взаємодія зі студіями та майстрами">
            <p>
              PlaniDay не є стороною договору між клієнтом і студією, салоном
