      ...
      <div className="w-full max-w-6xl px-4 py-8 sm:py-10 md:py-12">
        <div className="mx-auto max-w-md sm:max-w-lg md:max-w-xl">
          <div className="text-center">
            <h1 className="mt-15 text-xl font-black leading-[1.05] tracking-tight text-stone-800 sm:mt-14 sm:text-3xl md:mt-14 md:text-4xl">
              <span className="block">Реєстрація клієнта</span>
            </h1>
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-stone-200/60 bg-white shadow-[0_4px_24px_-4px_rgba(120,90,60,0.08)] sm:mt-6 sm:rounded-3xl md:mt-6">
